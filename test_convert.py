...
import numpy as np
import os
from convertors.losses import convert_smplx_2_star
from star.pytorch.star import STAR
from star.config import cfg


cfg.path_male_star = r'E:\VCL\Data\SMPL\star_1_1\male\model.npz'

########################################################################################################################
path_smplx_meshes = 'convertors/samples/smplx_meshes.npy'      #Path SMP-XL Meshes, a numpy array of SMPL verticies (batch_size x 6890 x 3)
...
def_transfer = np.load('convertors/def_transfer_smplx.npy', allow_pickle=True, encoding='latin1')[()]['mtx']
*smplx, = smplx
